  ...
  <div class="content-wrapper">
    ...
    <div>
      <div>
        ...
        <center><input type="text" class="form-control" id="search" placeholder="Nombre del doctor o enfermero"></center>
...
<br>
 ...
 <?php
    ...
    //Este es el código de la tabla, se pide un select para mostrar los datos, en el while se evalua al id de la tabla que en este caso es el número de cédula del médico 

   /*   require("conexion.php");
         $consulta='SELECT cedula,nombre,correo,privilegio,estatus from medico';
       ...
       <div class='tabla'>
          ...
          <?php
            ...
            while ($registros=mysqli_fetch_array($query)) {
              ...
              echo "<td>".$registros['privilegio']."</td>";
              echo "<td>".$registros['estatus']."</td>";
