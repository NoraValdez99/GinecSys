    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                <div class="external-event bg-green">Junta general</div>
                <div class="external-event bg-yellow">Vacaciones</div>
                <div class="external-event bg-aqua">Inventario</div>
                <div class="external-event bg-light-blue">Viajes de negocios</div>
                <div class="external-event bg-red">Días de descanso</div>
                <div class="checkbox">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Crear un nuevo evento</h3>
            </div>
            <div class="box-body">
