...
<!-- .................INICIA EL CONTENIDO DE LA PÁGINA ........................................-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!-- Aquí es dónde se encuentra el formulario que se vió en la interfaz, dónde tenemos una variable guardada en cada elemento para que se pueda vincular con el archivo PHP que hace todo el proceso de agregar -->
        ...
        <div class="form-container">
            ...
            <form method="post" action="agregar_paciente.php">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="no_citologia" placeholder="Número de citología " required>
                </div>  
                <div class="form-group">
               ...
               <!--
                <div class="form-group">
                    <input class="form-control" type="date" name="fec_nac" placeholder="Fecha de nacimiento" required>
                </div>
               -->
                <div class="form-group">
                    <input class="form-control" type="text" name="residencia" placeholder="Lugar de Residencia" required>
                </div>
                <div class="form-group">
                  Estado Civil
                <select class="form-control" type="text" name="edo_civil" placeholder="Estado Civil" required>
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="ocupacion" placeholder="Ocupación" required>
                </div>
                
                <div class="form-group">
                  Escolaridad
                <select class="form-control" type="text" name="escolaridad" placeholder="Escolaridad" required>
