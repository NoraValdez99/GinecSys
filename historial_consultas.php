...
require("conexion.php");
 ...
 $consulta='SELECT consulta.id_consulta, medico.nombre,paciente.nombre,consulta.servicio,consulta.fecha FROM paciente,medico,consulta WHERE consulta.fk_cedula=medico.cedula AND consulta.fk_paciente=paciente.id_paciente';
