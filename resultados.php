             ...
             <div class="">
                  ...
                  <br><br>
                   ...
                   <b>COLPOSCOPÍA</b><br>
                       ...
                       <input type="radio" name="zona_t" value="1.- UEC completamente visible">&nbsp;1.- UEC completamente visible&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;<br>
                       <input type="radio" name="zona_t" value="2.- UEC parcialmente visible">&nbsp;2.- UEC parcialmente visible
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                       <input type="radio" name="zona_t" value="3 uec no visible">&nbsp;3.- UEC no visible
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
                  ...
                  Evaluación del conducto cervical<br>
...
<br> <b>SALPINGOCLASIA</b>           <br><br>
                ...
                <b>PATRON MICROBIANO  Y VIRAL</b><br>
                    <input type="checkbox" name="n_e" value="No especifico. ">&nbsp;&nbsp;No especifico&nbsp;&nbsp;&nbsp;&nbsp;<br>
                    ...
                    <br><br>
                    <input type="checkbox" name="csed" value="Cuarto Superior Externo Derecho. ">&nbsp;&nbsp;C S E Der&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="csid" value="Cuarto Superior Interno Izquierdo. ">&nbsp;&nbsp;C S I Izq &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="csii" value="Cuarto Superior Interno Derecho. ">&nbsp;&nbsp;C S I Der &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="csei" value="Cuarto Superior Externo Izquierdo. ">&nbsp;&nbsp;C S E Izq &nbsp;&nbsp;&nbsp;&nbsp;<br>
                    <input type="checkbox" name="cied" value="Cuarto Inferior Externo Derecho. ">&nbsp;&nbsp;C I E Der &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ciid" value="Cuarto Inferior Interno Derecho. ">&nbsp;&nbsp;C I I Der &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ciii" value="Cuarto Inferior Interno Izquierdo. ">&nbsp;&nbsp;C I I Izq &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ciei" value="Cuarto Inferior Externo Izquierdo. ">&nbsp;&nbsp;C I E Izq &nbsp;&nbsp;&nbsp;&nbsp;<br>
