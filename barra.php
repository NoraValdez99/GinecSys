 <!-- AQUÍ COMIENZA LO DE LA BARRA AZUL DE LA PARTE DE ARRIBA .................................................................................... -->
  ...
  <header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>Gynec </b>Sys</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="dist/img/icono.png" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
            
          

              <span class="hidden-xs">Dr(a). <?php echo $_SESSION['nombre']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="dist/img/icono.png" height="100" width="100" class="img-circle" alt="User Image">
                <p>
                   Dr(a).<?php echo $_SESSION['nombre']; ?>
                </p>
              </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/icono.png" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>Dr(a). <?php echo $_SESSION['nombre']; ?></p>
          <!-- Status -->
        </div>
      </div>
      ...
      <li><a href="ultrasonido.php" ><i class="fa fa-link"></i> <span>Módulo de ultrasonido</span></a></li>


        <li><a href="historial_consultas.php" ><i class="fa fa-link"></i> <span>Historial de consultas</span></a></li>

        <!--calendario>
        <li><a href="calendario.php" ><i class="fa fa-link"></i> <span>Agenda</span></a></li>
        <fin calendario-->

        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Doctores</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="medicos.php">Doctores</a></li>
            <li><a href="nuevo_medico.php"  >Agregar nuevo</a></li>
          </ul>
        </li>
